...
double** createmat(double v1, double v2) {
    //Function to create a matrix with 2 rows and 2 columns	
...
node* matMul(node* mat1, node* mat2) {
	//Function to perform matrix multiplication on two linked matrices
	node* result = NULL;
...
void matScalarProduct(node* h1, double scalar) {
    //Function to multiply the matrix by a scalar value 	
    node *rp1, *dp1 = h1;
